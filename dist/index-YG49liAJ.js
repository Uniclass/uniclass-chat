...
var yw = (e, t = !1) => {
  ...
  mount(e) {
    ...
    const t = Np(() => {
      ...
      let a;
      g(this, Sn) ? a = g(this, Sn) : (a = gp(() => import("./BSBCIQID-VOvL4GCe.js")), P(this, Sn, a)), Tm(g(this, Cs));
      const c = this;
      return pp(a, vp({
        get queryFlavor() {
          return g(c, Es);
...
const lx = Lg({
  ...
  return ce(() => {
    ...
    /* @__PURE__ */ f.jsxs(zr, { className: "flex items-center border-b-[1px]", children: [
      /* @__PURE__ */ f.jsxs(Ns, { className: "max-w-[70%] text-center", children: [
        t.room_name,
        " (",
        t.room_id,
        ")"
...
const Gn = ({ children: e }) => /* @__PURE__ */ f.jsxs(Ze, { className: "p-3 flex flex-row gap-3 items-center text-red-400", children: [
  ...
  const { dataBaseApiUrl: n, authToken: s } = ec(), [i, o] = ee(null), [a, c] = ee(window.innerWidth <= 720);
  return ce(() => {
    const l = () => {
      c(window.innerWidth <= 720), r(!1);
    };
  ...
  const [i, o] = ee(window.innerWidth <= 720);
  return ce(() => {
    const a = () => {
      o(window.innerWidth <= 720), t(!1);
    };
...
}, Vx = new Mh(), Cw = ({ socketApiUrl: e, dataBaseApiUrl: t, authToken: r, userId: n }) => /* @__PURE__ */ f.jsx(zh, { client: Vx, children: /* @__PURE__ */ f.jsxs(Pm, { socketApiUrl: e, dataBaseApiUrl: t, authToken: r, userId: n, children: [
